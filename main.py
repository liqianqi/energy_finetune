...
parser = argparse.ArgumentParser()
parser.add_argument("--root_dir", default="/home/liqianqi/BUFF/ENERGY/images_m",type=str, help="输入根路径.")
parser.add_argument("--save_path", type=str,default="/home/liqianqi/BUFF/ENERGY/image1", help="输出根路径.")
parser.add_argument("--start_num", type=str,default='1120', help="起始计数.")
